...
\cventry{\experienceSpan}{Java/Sakai developer}{IT Services, University of Oxford}{Oxford}{United Kingdom}{
	\begin{itemize}
		\item Development of Weblearn, the VLE of the University of Oxford
		\begin{itemize}
			\item Customisation of an instance of the Open-Source project Sakai for the needs of the university
            \item Spring based, using multiple web technologies due to its modularity (Struts, Velocity, Wicket, JSF)
            \item Involvement in the Sakai community and contribution to the main project
		\end{itemize}
		\item Improvement of the Sakai search engine
		\begin{itemize}
			\item Creation of an implementation of Sakai-Search using Solr as the back end search engine
            \item Rewritting of the Sakai-Search API in the Search2 project, adding a clear separation between API and implementation to simplify the creation of new implementations
		\end{itemize}
		\item Creation of tools allowing the consumption of Sakai's APIs by third party applications
		\begin{itemize}
            \item Add OAuth1.0 support to Sakai, allowing connections on the behalf of any user
            \item Improvement of the existing services and creation of new REST endpoints
		\end{itemize}
