...
\cventry{\experienceSpan}{Java/JEE/Spring developer/trainer}{Zenika}{Paris}{France}{
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Studied an AMQP broker, RabbitMQ and published blog posts on its administration and usage: \httplink[Blog Zenika AMQP (fr)]{blog.zenika.com/index.php?tag/amqp}
		\end{itemize}
		\item Participated in the USI challenge: \httplink[Octo - Challenge USI 2011]{sites.google.com/a/octo.com/challengeusi2011/}
		\begin{itemize}
...
%		\end{itemize}
		...
		\begin{itemize}
			\item Wrote and taught XML basics and integration in Java.
...
\cventry{\experienceSpan}{Développeur et formateur Java/JEE/Spring}{Zenika}{Paris}{France}{
	\begin{itemize}
		...
		\begin{itemize}
			\item Spring IOC, Spring AOP, Spring DAO
			\item Etude d'un broker AMQP, RabbitMQ et publication de blogs sur son administration et fonctionnement : \httplink[Blog Zenika AMQP (fr)]{blog.zenika.com/index.php?tag/amqp}
		\end{itemize}
		\item Participation au concours USI : \httplink[Octo - Concours USI 2011]{sites.google.com/a/octo.com/challengeusi2011/}
		\begin{itemize}
